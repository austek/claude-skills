...
2. Locate and load my custom standard definitions for the detected language(s):
   ...
   - For Java specifically, also load `~/.claude/skills/java-coding-standards/SKILL.md`, `~/.claude/skills/java-testing/SKILL.md`, and `~/.claude/skills/java-tooling/SKILL.md` (each pulls in its own `rules/*.md`) — these carry the detailed rule sets to audit against.
   - For Scala specifically, also load `~/.claude/skills/scala-coding-standards/SKILL.md`, `~/.claude/skills/scala-testing/SKILL.md`, and `~/.claude/skills/scala-tooling/SKILL.md` (each pulls in its own `rules/*.md`) — these carry the detailed rule sets to audit against.
   - For Rust specifically, also load `~/.claude/skills/rust-coding-standards/SKILL.md`, `~/.claude/skills/rust-testing/SKILL.md`, and `~/.claude/skills/rust-tooling/SKILL.md` (each pulls in its own `rules/*.md`) — these carry the detailed rule sets to audit against.
